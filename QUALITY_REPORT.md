...
- Expanded the single-page prototype into a 17-route mobile-first product.
- Added five evidence-led explainers, a searchable library, onboarding, evidence dashboard, accessibility, privacy and offline pages.
...
- Cloudflare Pages Function with D1 storage and non-public status workflow.
...
1. Deploy through Cloudflare Pages Git integration.
2. Set `PUBLIC_SITE_URL` to the final hostname.
